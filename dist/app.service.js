...
const transporte_entity_1 = require("./entities/transporte.entity");
    ...
    async extraerYAlmacenarDatos() {
        ...
        try {
            ...
            for (const dato of datos) {
                const transporte = new transporte_entity_1.Transporte();
...
exports.AppService = AppService = __decorate([
    ...
    __param(0, (0, typeorm_1.InjectRepository)(transporte_entity_1.Transporte)),
